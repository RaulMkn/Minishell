...
void							set_error(t_lexer_state *state,
									t_error_type error, char *msg);
...
void							handle_buffer_token(t_token **tokens,
									char **buffer);
void							handle_whitespace(t_token **tokens,
									char **buffer, size_t *i, char *input);
void							handle_operator(t_token **tokens, char **buffer,
									size_t *i, char *input);
void							handle_quote_char(char **buffer, char c,
									size_t *i, t_shell *shell);
void							handle_regular_char(char **buffer, char c,
									size_t *i, t_shell *shell);
void							handle_final_buffer(t_token **tokens,
...
void							execute_child_command(t_cmd *curr,
									char ***mini_env);
void							handle_child_process(t_cmd *curr,
									char ***mini_env, int in_fd, int *pipe_fd);
int								handle_pipe_parent_process(int in_fd,
									int *pipe_fd, t_cmd *curr);
...
void							copy_string_chars(char *new, char *str,
									int len);
void							create_word_token(t_token **tokens,
									char **buffer);
...
int								process_word_token(t_token **current,
									char ***argv, int *argc);
