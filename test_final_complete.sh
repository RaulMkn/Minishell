...
<parameter name="todos">[{"content": "Analizar implementaci\u00f3n actual de heredocs", "status": "completed", "activeForm": "Analyzing current heredoc implementation"}, {"content": "Implementar lectura completa de heredocs", "status": "completed", "activeForm": "Implementing complete heredoc reading"}, {"content": "Arreglar echo -n formatting", "status": "completed", "activeForm": "Fixing echo -n formatting"}, {"content": "Verificar y corregir redirections", "status": "completed", "activeForm": "Verifying and fixing redirections"}, {"content": "Probar todos los casos b\u00e1sicos", "status": "completed", "activeForm": "Testing all basic cases"}, {"content": "Ejecutar tests completos", "status": "in_progress", "activeForm": "Running complete tests"}]