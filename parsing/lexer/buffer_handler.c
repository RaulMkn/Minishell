...
/*   Updated: 2025/08/16 19:06:35 by ruortiz-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	handle_word(t_token **tokens, char *word, t_shell *shell)
{
	...
	// Si estamos procesando un argumento de 'echo' con comillas simples, preservar literal
	if (cmd_name && ft_strcmp(cmd_name, "echo") == 0 && 
		word[0] == '\'' && word[ft_strlen(word)-1] == '\'')
	{
		// Para 'echo' con comillas simples, mantener comillas para procesamiento posterior
